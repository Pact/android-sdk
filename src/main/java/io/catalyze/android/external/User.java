...
import io.catalyze.exceptions.IllegalPasswordFormatException;
import io.catalyze.exceptions.IllegalUsernameFormatException;
...
public class User extends CatalyzeObject {
     ...
     * @throws io.catalyze.exceptions.IllegalUsernameFormatException
     ...
     * @throws io.catalyze.exceptions.IllegalPasswordFormatException
