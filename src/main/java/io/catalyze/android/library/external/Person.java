...
import io.catalyze.android.library.exceptions.IllegalAgeFormatException;
...
public class Person extends CatalyzeObject {
    ...
    /**
     * @return the {@link Gender} of this {@link Person}
     */
     ...
     * @throws io.catalyze.android.library.exceptions.IllegalAgeFormatException
