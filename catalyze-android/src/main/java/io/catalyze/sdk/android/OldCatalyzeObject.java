 ...
 */
public class OldCatalyzeObject {
    ...
    static String getAppId() {
        ...
        return checkNotNull(sAppId,
                "Specify the appId by calling " + OldCatalyzeObject.class.getSimpleName()
                        + ".setAppId()");
    }
    ...
    protected Request create(RequestQueue queue, Response.ErrorListener errorListener,
        ...
        OldCatalyzeJsonObjectRequest request = new OldCatalyzeJsonObjectRequest(Request.Method.POST,
    ...
    protected Request retrieve(RequestQueue queue, Response.ErrorListener errorListener,
            String path) {
        final OldCatalyzeObject holder = this;
        OldCatalyzeJsonObjectRequest request = new OldCatalyzeJsonObjectRequest(Request.Method.GET,
                path, new JSONObject(mContent), new Response.Listener<JSONObject>() {
