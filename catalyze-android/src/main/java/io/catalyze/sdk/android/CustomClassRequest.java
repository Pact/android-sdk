...
public class CustomClassRequest {
    ...
    public static class Builder extends CatalyzeRequest.Builder<CustomClass> {

        protected Builder(Context context, String className) {
            super(context, String.format(URL, Catalyze.INSTANCE.getAppId(), className));
        }

        @Override
        public CatalyzeRequest.Builder<CustomClass> setContent(CustomClass body) {
            setJson(body.asJson());
            return this;
        }

        @Override
        public CatalyzeRequest.Builder<CustomClass> setListener(final Response
